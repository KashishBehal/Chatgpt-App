...
// let arr=[
//   {type:"user " , post:"fafafafafas"} , 
//   {type:"bot" , post:"fafafafaaaaaaaafas"} , 
...
return data;
 ...
 const autoTypingBotResponse=(text)=>{
  ...
  return (<main className="chatGPT-app">
      ...
      <div  className="layout">
        {posts.map((post, index) => (
          <div key={index} className={`chat-bubble ${post.type === "bot" || post.type === "loading" ? "bot" : ""}`}>
            ...
            {post.type === "loading" ? (<div className="loader"><img src={loadingIcon} /></div>) : (<div className="post">
              {post.post}
            </div>)}
    ...
    <footer>
      <input   value={input} className='composebar' autoFocus type='text'
        placeholder='Hey Friend  , Ask me anything ...'
